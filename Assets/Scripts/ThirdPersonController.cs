...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private float _cinemachineCameraDistance;
        ...
        private bool _movingFacingCamera;
        ...
        private void Start()
        {
            ...
            _cinemachineCameraDistance = (_componentBase as Cinemachine3rdPersonFollow).CameraDistance;
        ...
        private void Move()
        {
            // set target speed based on move speed, walk speed and if walk is pressed
            float targetSpeed = _input.walk ? WalkSpeed : MoveSpeed;
        ...
        private void Target()
        {
            _playerInput.actions["clickTarget"].performed += _ => TargetObject();
        ...
        private void RightClickCheck()
        {
            ...
            void lockCursor()
            {
                _movingFacingCamera = true;
                Cursor.visible = false;
            }
            void unlockCursor()
            {
                Cursor.visible = true;
                _movingFacingCamera = false;
            }
        }
        ...
        private void CameraRotation()
        {
            ...
            if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition && _movingFacingCamera == true)
            {
        ...
        private void CameraZoom()
        {
            ...
            if (_input.scroll != 0 && 
                _input.scroll > 0 && _cinemachineCameraDistance > cameraMaxZoomDistance || 
                _input.scroll < 0 && _cinemachineCameraDistance < 0 || 
                (_cinemachineCameraDistance > 0 && _cinemachineCameraDistance < cameraMaxZoomDistance))
            {
                _cinemachineCameraDistance -= _input.scroll / 300f;
            }
